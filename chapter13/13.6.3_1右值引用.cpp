/*
    ...
    类似标准库容器的push_back，这些容器会定义2个版本的push_back
...
public:
    ...
    void push_back(const std::string&);  //拷贝版本
    void push_back(std::string &&);      //移动版本
...
void StrVec::push_back(const std::string& s )
{
    ...
    std::cout<<"copy version push_back"<<std::endl;
}
...
void StrVec::push_back(std::string &&s)
{
    ...
    std::cout<<"move version push_back "<<std::endl;
}
